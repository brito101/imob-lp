                    ...
                    <div class="col-12 col-lg-6">
                        <div class="card">
                                    ...
                                    <table class="table m-0">
                                        ...
                                        <tbody>
                                            @forelse ($contacts as $contact)
                                                <tr>
                                                    <td><a title="Editar contato"
                                                            href="{{ route('admin.contacts.edit', ['contact' => $contact->id]) }}">{{ $contact->id }}</a>
                                                    </td>
                                                    <td>{{ $contact->name }}</td>
                                                    <td>{{ $contact->email }}</td>
                                                    <td>{{ $contact->phone }}
                            ...
                            <div class="card-footer clearfix">
                                @can('Criar Contatos')
                                    <a href="{{ route('admin.contacts.create') }}" class="btn btn-sm btn-info float-left">Criar
                                        Novo</a>
                                @endcan
                                @can('Listar Contatos')
                                    <a href="{{ route('admin.contacts.index') }}"
                                        class="btn btn-sm btn-secondary float-right">Ver Todos</a>
                                @endcan
                            </div>
