...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-address-book"></i> Contatos</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Contatos Cadastrados</h3>
                                @can('Criar Contatos')
                                    <a href="{{ route('admin.contacts.create') }}" title="Novo Contato"
                                        class="btn btn-success"><i class="fas fa-fw fa-plus"></i>Novo Contato</a>
                                @endcan
                            </div>
                        </div>

                        @php
                            $heads = [['label' => 'ID', 'width' => 10], 'Nome', 'E-mail', 'Telefone', ['label' => 'Ações', 'no-export' => true, 'width' => 10]];
                            $config = [
                                'ajax' => url('/admin/contacts'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'name', 'name' => 'name'], ['data' => 'email', 'name' => 'email'], ['data' => 'phone', 'name' => 'phone'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
